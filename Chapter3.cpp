...
#include<iostream>
#include <iomanip>
//iomanip provides the function setPrecision which is used later
int main() {
			/*
			* Data types
		...
		//FLoating point types/Fractionals
			...
			*/
			...
			//testing out scientific notation
		...
		//Assignments
			...
			*/
			...
			//Assigning a value that is not supported
